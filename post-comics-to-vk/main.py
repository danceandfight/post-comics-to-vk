...
def check_vk_response_for_error(response, response_json):
...
def upload_comics(url, comment, filename):
    ...
    response_data = response.json()
    check_vk_response_for_error(response, response_data)
    ...
    check_vk_response_for_error(response, response.json())
